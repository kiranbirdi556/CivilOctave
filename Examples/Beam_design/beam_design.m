...
Mu_lim=interp2(table,table,table,beam.fy,beam.fck)

%factored moment by applied loading
Mu=beam.factored_moment/(beam.width*eff_depth^2);
...
fprintf("\n");
 ...
 %percentage tensile reinforcement and compression reinforcement
 pt=interp2(tensile_reinforcement,tensile_reinforcement,...
            tensile_reinforcement,d,Mu);
 
 pc=interp2(compression_reinforcement,compression_reinforcement,...
            compression_reinforcement,d,Mu);
